...
$factory->define(Product::class, function (Faker $faker) {
    ...
    return[
        ...
        'item_product_buy' => $faker->numberBetween(1000, 10000),
        'item_product_sell' => $faker->numberBetween(1000, 10000),
        'item_product_discount' => $faker->numberBetween(10000, 20000),
        'item_product_price' => $faker->numberBetween(1000, 10000),
        'item_product_stroke' => $faker->numberBetween(2000, 12000),
