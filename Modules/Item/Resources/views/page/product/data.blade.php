    ...
    <div class="panel-body">
        ...
        <div class="navbar-fixed-bottom" id="menu_action">
            <div class="text-right" style="padding:5px">
                @if($action_code == 'stock_data')
                <button type="submit" onclick="return confirm('Are you sure to sync data ?');" id="delete-action"
                    value="sync" name="action" class="btn btn-primary">Sync</button>
                @else
