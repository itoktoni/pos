...
class PurchaseDetailRepository extends PurchaseRepository implements MasterInterface
{
    ...
    public $mapping  = [
        ...
        'detail' => [
            'purchase_detail_item_product_id' =>  'purchase_detail_item_product_id',
            'purchase_detail_qty_order' => 'purchase_detail_qty_order',
            'purchase_detail_price_order' => 'purchase_detail_price_order',
            'purchase_detail_total_order' => 'purchase_detail_total_order',
        ]
    ];
