    ...
    <tbody>
        <tr>
            ...
            <td data-title="" class="text-right">
                {!! Form::text('sales_purchase_sum_product', null, ['id' => 'before_discount',
        ...
        <tr style="margin-bottom: 20px;">
            ...
            <td data-title="Description" class="text-left col-md-4">
                {!! Form::textarea('sales_purchase_discount_name', null, ['id' => 'grand_discount_description', 'class' =>
                'form-control', 'rows' => 2, 'tabindex' => 500]) !!}
            </td>
            <td data-title="Value" class="text-right col-md-1">
                {!! Form::text('sales_purchase_discount_value', null, ['id' => 'grand_discount_value', 'placeholder' =>
                'Input Value' ,'class' => 'number form-control text-right', 'tabindex' => 501]) !!}
            </td>
            <td data-title="Price" class="text-right col-md-1">
                {!! Form::text('sales_purchase_discount_value', null, ['id' => 'grand_discount_price',
                'readonly', 'class' => 'number form-control text-right', 'tabindex' => 502]) !!}
            </td>
            <td data-title="Total" class="text-right col-md-1">
                {!! Form::text('sales_purchase_sum_discount', null, ['id' => 'grand_discount_total',
                'readonly', 'class' => 'number form-control text-right']) !!}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td data-title="" class="text-right">
                {!! Form::text('sales_purchase_sum_total', null, ['id' => 'grand_total',
                'readonly', 'class' => 'number form-control text-right']) !!}
            </td>
        </tr>
    </tbody>
