<div class="form-group">
    <input type="hidden" name="sales_order_code_purchase" value="{{ $model->sales_purchase_id }}">

    {!! Form::label('name', 'Company', ['class' => 'col-md-2 control-label']) !!}
    <div class="col-md-4 {{ $errors->has('sales_order_from_id') ? 'has-error' : ''}}">
        {{ Form::select('sales_order_from_id', $company, $model->sales_purchase_from_id, ['class'=> 'form-control', 'id' => 'from_id']) }}
    ...
    <div class="col-md-4 {{ $errors->has('sales_order_from_name') ? 'has-error' : ''}}">
        {!! Form::text('sales_order_from_name', $model->sales_purchase_from_name, ['class' => 'form-control', 'id' =>
        'from_name']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has('sales_order_from_phone') ? 'has-error' : ''}}">
        {!! Form::text('sales_order_from_phone', $model->sales_purchase_from_phone, ['class' => 'form-control', 'id' =>
        'from_phone']) !!}
    ...
    <div class="col-md-4 {{ $errors->has('sales_order_from_email') ? 'has-error' : ''}}">
        {!! Form::text('sales_order_from_email', $model->sales_purchase_from_email, ['class' => 'form-control', 'id' =>
        'from_email']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-10 {{ $errors->has('sales_order_from_address') ? 'has-error' : ''}}">
        {!! Form::textarea('sales_order_from_address', $model->sales_purchase_from_address, ['class' => 'form-control',
        'rows' => 3, 'id' =>
        'from_address']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has('sales_order_to_id') ? 'has-error' : ''}}">
        {{ Form::select('sales_order_to_id', $customers, $model->sales_purchase_to_id, ['class'=> 'form-control', 'id' => 'to_id']) }}
    ...
    <div class="col-md-4 {{ $errors->has('sales_order_to_name') ? 'has-error' : ''}}">
        {!! Form::text('sales_order_to_name', $model->sales_purchase_to_name, ['class' => 'form-control', 'id' =>
        'to_name']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has('sales_order_to_phone') ? 'has-error' : ''}}">
        {!! Form::text('sales_order_to_phone', $model->sales_purchase_to_phone, ['class' => 'form-control', 'id' =>
        'to_phone']) !!}
    ...
    <div class="col-md-4 {{ $errors->has('sales_order_to_email') ? 'has-error' : ''}}">
        {!! Form::text('sales_order_to_email', $model->sales_purchase_to_email, ['class' => 'form-control', 'id' =>
        'to_email']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-10 {{ $errors->has('sales_order_to_address') ? 'has-error' : ''}}">
        {!! Form::textarea('sales_order_to_address', $model->sales_purchase_to_address, ['class' => 'form-control',
        'rows' => 3, 'id' =>
        'to_address']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has('sales_order_date_order') ? 'has-error' : ''}}">
        {!! Form::text('sales_order_date_order', $model->sales_purchase_date ?? date('Y-m-d'), ['class' =>
        'form-control date']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-10 {{ $errors->has('sales_order_notes_internal') ? 'has-error' : ''}}">
        {!! Form::textarea('sales_order_notes_internal', $model->sales_purchase_notes_internal, ['class' =>
        'form-control', 'rows' => 2]) !!}
...
<div class="form-group">
    ...
    <div class="col-md-10 {{ $errors->has('sales_order_notes_external') ? 'has-error' : ''}}">
        {!! Form::textarea('sales_order_notes_external', $model->sales_purchase_notes_external, ['class' =>
...
<div class="form-group">
    ...
    <div class="col-md-4 {{ $errors->has('sales_order_term_top') ? 'has-error' : ''}}">
        {{ Form::select('sales_order_term_top', $tops, $model->sales_purchase_term_top, ['class'=> 'form-control', 'id' => 'top_id']) }}
    ...
    <div class="col-md-4 {{ $errors->has('sales_order_term_valid') ? 'has-error' : ''}}">
        <div class="input-group">
            {!! Form::text('sales_order_term_valid', $model->sales_purchase_term_valid, ['class' => 'form-control',
...
<div class="form-group">
    ...
    <div class="col-md-10 {{ $errors->has('sales_order_term_product') ? 'has-error' : ''}}">
        {!! Form::textarea('sales_order_term_product', $model->sales_purchase_term_product, ['class' => 'form-control
        simple']) !!}
